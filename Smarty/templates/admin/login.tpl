...
<div id="login-wrap">
    ...
    <div id="login-form" class="clearfix">
        <h1>
            <!-- <img src="<!--{$TPL_URLPATH}-->img/contents/admin_login_logo.gif" width="300" height="150" alt="EC-CUBE管理画面" /> -->
...
<div id="copyright">Copyright &copy; 2013-<!--{$smarty.now|date_format:"%Y"}--> B&B CLOTHING CO. All Rights Reserved</div>
