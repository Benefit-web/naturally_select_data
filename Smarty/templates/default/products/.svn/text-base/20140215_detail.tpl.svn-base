    ...
    <div id="detailarea" class="clearfix">
                ...
                <!--{if $arrProduct[$key] != "" or $arrProduct[$ikey]|strlen >= 1}-->
                    <div class="sub_photo_area">
                        ...
                        <!--{if $arrProduct[$ikey]|strlen >= 1}-->
                            <div class="sub_single_image">
                                <!--{if $arrProduct[$lkey]|strlen >= 1}-->
                                    <a href="<!--{$smarty.const.IMAGE_SAVE_URLPATH}--><!--{$arrProduct[$lkey]|h}-->" class="expansion" target="_blank" >
                                <!--{/if}-->
                                <img src="<!--{$arrFile[$ikey].filepath}-->" alt="<!--{$arrProduct.name|h}-->" width="<!--{$arrFile[$ikey].width}-->" height="<!--{$arrFile[$ikey].height}-->" /></a>
                            </div>
                        <!--{else}-->
        ...
        <div id="detailrightbloc">
            ...
            <div class="detail_brand_banner">
                <img src="<!--{$TPL_URLPATH}-->img/brand/<!--{$arrProduct.maker_id|h}-->.gif" alt="<!--{$arrProduct.maker_name|h}-->" width="100%"/>
            </div>
            ...
            <!--{if count($ps) > 0}-->
                <ul class="status_icon clearfix">
                    ...
                    <li>
                        <img src="<!--{$TPL_URLPATH}--><!--{$arrSTATUS_IMAGE[$status]}-->" height="40" alt="<!--{$arrSTATUS[$status]}-->" id="icon<!--{$status}-->" />
                    </li>
                    <!--{/foreach}-->
                </ul>
            <!--{/if}-->
