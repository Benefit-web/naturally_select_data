...
<!--{assign var=lkey value="sub_large_image`$smarty.section.cnt.index+11`"}-->
	<!--{if $arrProduct.$lkey != NULL}-->
	<img src="/upload/save_image/<!--{$arrProduct.$lkey}-->" alt="" width="100%" style="margin-bottom:5px;"/>
	<!--{/if}-->
<!--{/section}-->
</div>
</form>
