...
<div style="margin: 10px 0 10px 0;">
    <img src="<!--{$TPL_URLPATH}-->img/banner/paperwallet_sale.jpg" alt="セールバナー" width="765px"/>
</div>
<div id="undercolumn">
    ...
    <!--★タイトル★-->
    <p class="block_name_list"><!--{$tpl_subtitle|h}--></p>
    <!--▼検索条件-->
            ...
            <div class="listrightbloc">
                ...
                <div class="detail_btn">
                    <div class="check_item_detail">
                        ...
                        <a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->">このアイテムを見る ></a>
                    </div>
                </div>
