...
<div id="undercolumn">
    <div id="undercolumn_shopping">
        <p class="block_name_list"><!--{$tpl_title|h}--><span>Payment Method And Delivery Time</span></p>
        <p class="flow_area">
            <img src="<!--{$TPL_URLPATH}-->img/common/order_flow_3.jpg" alt="購入手続きの流れ" />
        </p>
        ...
        <div>
            ...
            <img src="<!--{$TPL_URLPATH}-->img/common/web_pay_card.jpg" alt="クレジットカードご利用可能種類" />
        </div>
        ...
        <div class="pay_area02">
            ...
            <ul>
                <li style="float: left"><input type="radio" name="gift_check" value="1" <!--{$arrForm.gift_check.value|sfGetChecked:1}-->  /><label for="gift_on">希望する</label></li>
                <li style="float: left"><input type="radio"  name="gift_check" value="2" <!--{$arrForm.gift_check.value|sfGetChecked:2}-->  /><label for="gift_off">希望しない</label></li>
            </ul>
            <img style="margin-top:15px;" src="<!--{$TPL_URLPATH}-->img/common/gift_packing.gif" alt="ギフト梱包について" />
        </div>
        <!-- ▲ギフト選択 ここまで-->
