...
<div class="frame_outer">
	...
	<a href="https://naturally-select.jp/products/list.php?category_id=18"><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/banner.jpg" style="margin-bottom:15px;" alt="" /></a>
        <!--{* ▼CENTER COLUMN *}-->
        ...
        <li><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/1.jpg" alt="" /></li>  
        <li><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/2.jpg" alt="" /></li>  
        <li><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/3.jpg" alt="" /></li>  
        <li><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/4.jpg" alt="" /></li>  
        <li><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/5.jpg" alt="" /></li>  
        </ul>  
        </div>  
        <div class="bx-pager">  
        <a data-slide-index="0" href=""><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/thumb/1.jpg" /></a>  
        <a data-slide-index="1" href=""><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/thumb/2.jpg" /></a>  
        <a data-slide-index="2" href=""><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/thumb/3.jpg" /></a>  
        <a data-slide-index="3" href=""><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/thumb/4.jpg" /></a>  
        <a data-slide-index="4" href="" class="thumb-edge"><img src="<!--{$TPL_URLPATH}-->img/banner/bnr_top_main/thumb/5.jpg" /></a>  
        </div>  
        <!-- /#slider -->
        </div> 
        </div>
