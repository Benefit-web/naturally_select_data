<?php /* Smarty version 2.6.26, created on 2014-09-15 21:08:01
         compiled from main_frame.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'printXMLDeclaration', 'main_frame.tpl', 1, false),array('modifier', 'script_escape', 'main_frame.tpl', 28, false),array('modifier', 'count', 'main_frame.tpl', 59, false),array('modifier', 'h', 'main_frame.tpl', 91, false),array('modifier', 'date_format', 'main_frame.tpl', 159, false),)), $this); ?>
...
<title>NaturallySelect.サイト管理画面</title>
...
<div id="header">
    <div id="header-contents">
        <div id="logo">
            <a href="<?php echo ((is_array($_tmp=@ADMIN_HOME_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
">
                <img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
img/header/logo.jpg" width="268" height="43" alt="EC-CUBE" />
            </a>
        </div>
        <div id="site-check">
...
<div id="footer">
    <div id="footer-contents">
        <div id="copyright">Copyright &copy; 2013-<?php echo ((is_array($_tmp=((is_array($_tmp=time())) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y") : smarty_modifier_date_format($_tmp, "%Y")); ?>
 B&B CLOTHING CO. All Rights Reserved.</div>
        <div id="topagetop">
            <ul class="sites">
