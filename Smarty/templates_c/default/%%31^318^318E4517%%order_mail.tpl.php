...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail_templates/order_mail.tpl', 22, false),array('modifier', 'number_format', 'mail_templates/order_mail.tpl', 31, false),array('modifier', 'default', 'mail_templates/order_mail.tpl', 31, false),array('modifier', 'sfCalcIncTax', 'mail_templates/order_mail.tpl', 54, false),array('modifier', 'date_format', 'mail_templates/order_mail.tpl', 83, false),)), $this); ?>
...
）
<?php if (((is_array($_tmp=$this->_tpl_vars['arrOrder']['gift_check'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?>
ギフト梱包料 ￥ 1.080
<?php endif; ?>
