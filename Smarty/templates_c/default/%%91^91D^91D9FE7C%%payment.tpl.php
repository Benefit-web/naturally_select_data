<?php /* Smarty version 2.6.26, created on 2014-11-16 18:32:48
         compiled from /var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 36, false),array('modifier', 'h', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 122, false),array('modifier', 'sfGetErrorColor', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 154, false),array('modifier', 'sfGetChecked', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 154, false),array('modifier', 'nl2br', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 157, false),array('modifier', 'default', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 229, false),array('modifier', 'number_format', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 263, false),array('function', 'html_options', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/payment.tpl', 230, false),)), $this); ?>
...
<span>Payment Method And Delivery Time</span></p>
        <p class="flow_area">
            <img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
img/common/order_flow_3.jpg" alt="購入手続きの流れ" />
        </p>
        <p>本サイトではSSLサーバ証明書を導入しております。</p>
        <p>これによりお客様が送られる全ての情報は暗号化され、改竄・漏洩する事が無いことを保証いたします。</p>
        <p>数量に限りがございますので、ご購入手続きの間に在庫切れとなってしまう可能性がございます。ご了承ください。 </p></br>
...
" />
        ...
        <div>
            <p class="attention">※クレジットカードをご選択されたお客様へ</p>
            <p class="select-msg">クレジットカード情報はご注文手続き完了後にご入力して頂けます。</p>
            <img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
img/common/web_pay_card.jpg" alt="クレジットカードご利用可能種類" />
        </div>
...
">
        ...
        <div class="pay_area02">
            <h3>ギフト梱包</h3>
            <p class="select-msg">ギフト梱包をご希望の方は、「希望する」にチェックを入れてください。</p>
            <ul>
                <li style="float: left"><input type="radio" name="gift_check" value="1" <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['gift_check']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetChecked', true, $_tmp, 1) : SC_Utils_Ex::sfGetChecked($_tmp, 1)); ?>
  /><label for="gift_on">希望する</label></li>
                <li style="float: left"><input type="radio"  name="gift_check" value="2" <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['gift_check']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetChecked', true, $_tmp, 2) : SC_Utils_Ex::sfGetChecked($_tmp, 2)); ?>
  /><label for="gift_off">希望しない</label></li>
            </ul>
            <img style="margin-top:15px;" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
img/common/gift_packing.gif" alt="ギフト梱包について" />
        </div>
        <!-- ▲ギフト選択 ここまで-->
