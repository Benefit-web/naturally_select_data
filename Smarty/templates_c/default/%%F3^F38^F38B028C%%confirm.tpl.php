<?php /* Smarty version 2.6.26, created on 2014-11-18 00:18:32
         compiled from /var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 23, false),array('modifier', 'h', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 49, false),array('modifier', 'strlen', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 95, false),array('modifier', 'sfNoImageMainList', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 95, false),array('modifier', 'sfCalcIncTax', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 112, false),array('modifier', 'number_format', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 112, false),array('modifier', 'default', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 133, false),array('modifier', 'nl2br', '/var/www/html/naturally_select/html/../../../data/Smarty/templates/default/shopping/confirm.tpl', 300, false),)), $this); ?>
...
img/common/order_flow_4.jpg" alt="購入手続きの流れ" /></p>
        <p class="information">下記ご注文内容で送信してもよろしいでしょうか？<br />
            よろしければ、「<?php if (((is_array($_tmp=$this->_tpl_vars['use_module'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>次へ<?php else: ?>ご注文完了ページへ<?php endif; ?>」ボタンをクリックしてください。<br />
            <?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['payment_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)) == 5): ?><span style="color:red">※お支払い方法に「クレジットカード」を選択して頂いたお客様は次のステップにて「クレジットカード支払手続きへ」ボタンで<br />お支払い手続きを行って下さい。</span><?php endif; ?>
        </p>
...
" />
        <input type="hidden" name="paymentid" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrForm']['payment_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" />
        <div class="btn_area">
            <ul>
                <li>
...
円</td>
            ...
            <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['gift_check'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '1'): ?>
            <tr>
                <th colspan="4" class="alignR" scope="row">ギフト梱包料</th>
                <td class="alignR">1,080円</td>
            </tr>
            <?php endif; ?>
...
円</td>
            ...
            <?php endif; ?>
            <tr>
                <th colspan="4" class="alignR" scope="row">
                    <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['mail_shipment_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == true): ?>
                    送料(メール便)
                    <?php else: ?>
                    <span style="color:red;">※商品3口以上またはギフト梱包での発送は佐川急便基本料金となります。</span>送料(佐川急便基本料金)
                    <?php endif; ?>
                </th>
