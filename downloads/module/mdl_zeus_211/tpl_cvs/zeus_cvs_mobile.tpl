<p>ｺﾝﾋﾞﾆ決済の申し込みを行ないます。</p>
<br>
※「次へ」をクリックするとご注文確定となります。内容変更ができませんので、予めご了承ください。<br>
※そのあと決済用サイトに遷移します。引き続きお手続きを進めてください。<br>
※画面が変わらない場合には、「次へ」をクリックしてください。<br />
<form method="post" name="nextform" action="<!--{$cvsLinkPointUrl}-->" Accept-charset="shift_jis">
